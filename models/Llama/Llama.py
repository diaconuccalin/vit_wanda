# From https://github.com/meta-llama/llama3/tree/main
...
class Llama:
    ...
    def build(
        ...
        Args:
            ...
            params_path (str): Path to the model parameters file.
        ...
        # Generate model arguments object
